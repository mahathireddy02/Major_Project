...
// =============================================================================
const STUDENTS_SEED = [
  { id: 's1', name: 'Demo Student', email: 'demostudent@gmail.com', studentId: '21IND0501', rollNumber: '21IND0501', collegeName: 'Sri Indu College of Engineering & Technology', department: 'Computer Science', year: 3, phone: '+91 98765 43210', avatar: 'DS', rating: 4.9, totalRides: 38, isVerified: true, role: 'STUDENT', gender: 'Male' },
...
// =============================================================================
const FACULTY_SEED = [
  { id: 'f1', name: 'Demo Faculty', email: 'demofaculty@gmail.com', studentId: 'FAC-2026-001', collegeId: 'FAC-2026-001', collegeName: 'Sri Indu College of Engineering & Technology', department: 'Computer Science & Engineering', year: 1, phone: '+91 91234 56780', avatar: 'DF', rating: 5.0, totalRides: 64, isVerified: true, role: 'FACULTY', gender: 'Male' },
...
// =============================================================================
// Drivers Seed Data (All with personal @gmail.com email addresses)
// =============================================================================
const DRIVERS_SEED = [
  { id: 'd1', name: 'Demo Driver', email: 'demodriver@gmail.com', phone: '+91 99887 76655', avatar: 'DD', rating: 4.8, totalTrips: 312, isVerified: true, role: 'DRIVER', vehicleId: 'v1', vehicleRegistration: 'TS 09 AB 1234', vehicleType: 'Campus Shuttle Bus', licenseNumber: 'TS-09-2018-004521' },
  { id: 'sd1', name: 'Demo Student Driver', email: 'demostudentdriver@gmail.com', phone: '+91 98765 43299', avatar: 'SD', rating: 4.9, totalTrips: 45, isVerified: true, role: 'DRIVER', vehicleId: 'v-sd1', vehicleRegistration: 'TS 09 SD 2026', vehicleType: 'Car', licenseNumber: 'TS-09-2022-009876' },
...
const VEHICLES_SEED = [
  ...
  { id: 'v-sd1', name: 'Demo Student Car (V-SD1)', driverId: 'sd1', vehicleType: 'Car', registrationNumber: 'TS 09 SD 2026', capacity: 4, status: 'AVAILABLE', color: '#10B981', rating: 4.9, totalTrips: 45 },
]
