...
// =============================================================================
const STUDENTS_SEED = [
  { id: 's1', name: 'Uday Kiran (Demo Student)', email: 'student.demo@sriindu.ac.in', studentId: 'STUDENT-DEMO-2026', rollNumber: '21IND0501', collegeName: 'Sri Indu College of Engineering & Technology', department: 'Computer Science', year: 3, phone: '+91 98765 43210', avatar: 'UK', rating: 4.9, totalRides: 38, isVerified: true, role: 'STUDENT' },
  { id: 's2', name: 'Arjun Rao', email: 'arjun.rao@iith.ac.in', studentId: 'IITH2022015', rollNumber: 'EE22BTECH11015', collegeName: 'IIT Hyderabad', department: 'Electrical Engg', year: 2, phone: '+91 87654 32109', avatar: 'AR', rating: 4.7, totalRides: 22, isVerified: true, role: 'STUDENT' },
  { id: 's3', name: 'Priya Sharma', email: 'priya.sharma@nitw.ac.in', studentId: 'NITW2021034', rollNumber: 'ME21B034', collegeName: 'NIT Warangal', department: 'Mechanical Engg', year: 3, phone: '+91 76543 21098', avatar: 'PS', rating: 4.8, totalRides: 31, isVerified: true, role: 'STUDENT' },
  { id: 's4', name: 'Rahul Varma', email: 'rahul.varma@cbit.ac.in', studentId: 'CBIT2023007', rollNumber: '160123733007', collegeName: 'Chaitanya Bharathi Institute of Technology', department: 'Computer Science', year: 1, phone: '+91 65432 10987', avatar: 'RV', rating: 4.6, totalRides: 9, isVerified: true, role: 'STUDENT' },
  { id: 's5', name: 'Sneha Reddy', email: 'sneha.reddy@osmania.ac.in', studentId: 'OU2022023', rollNumber: '100522737023', collegeName: 'Osmania University', department: 'Information Tech', year: 2, phone: '+91 54321 09876', avatar: 'SR', rating: 4.9, totalRides: 45, isVerified: true, role: 'STUDENT' },
  { id: 's6', name: 'Karthik Naidu', email: 'karthik.naidu@jntuh.ac.in', studentId: 'JNTU2021009', rollNumber: '21011A0409', collegeName: 'JNTU Hyderabad', department: 'Electronics', year: 3, phone: '+91 43210 98765', avatar: 'KN', rating: 4.5, totalRides: 17, isVerified: true, role: 'STUDENT' },
  { id: 's7', name: 'Ananya Patel', email: 'ananya.patel@iiit.ac.in', studentId: 'IIIT2020044', rollNumber: '2020101044', collegeName: 'IIIT Hyderabad', department: 'AI & Data Science', year: 4, phone: '+91 32109 87654', avatar: 'AP', rating: 4.8, totalRides: 56, isVerified: true, role: 'STUDENT' },
  { id: 's8', name: 'Rohit Kumar', email: 'rohit.kumar@uohyd.ac.in', studentId: 'UOH2022003', rollNumber: '22MBBA03', collegeName: 'University of Hyderabad', department: 'Management', year: 2, phone: '+91 21098 76543', avatar: 'RK', rating: 4.3, totalRides: 12, isVerified: true, role: 'STUDENT' },
  { id: 's9', name: 'Meera Singh', email: 'meera.singh@bits-pilani.ac.in', studentId: 'BITS2021018', rollNumber: '2021A1PS0018H', collegeName: 'BITS Pilani Hyderabad', department: 'Biotechnology', year: 3, phone: '+91 10987 65432', avatar: 'MS', rating: 4.7, totalRides: 28, isVerified: true, role: 'STUDENT' },
  { id: 's10', name: 'Vivek Reddy', email: 'vivek.reddy@campusflow.io', studentId: 'CF2022031', rollNumber: 'CF2022CE31', collegeName: 'CampusFlow Academy', department: 'Civil Engg', year: 2, phone: '+91 09876 54321', avatar: 'VR', rating: 4.6, totalRides: 19, isVerified: true, role: 'STUDENT' },
]
...
const FACULTY_SEED = [
  ...
  { id: 'f2', name: 'Prof. Lakshmi Nair', email: 'prof.lakshmi.nair@iith.ac.in', studentId: 'FAC-IITH-012', collegeId: 'FAC-IITH-012', collegeName: 'IIT Hyderabad', department: 'Electrical Engineering', year: 1, phone: '+91 82345 67891', avatar: 'LN', rating: 4.9, totalRides: 42, isVerified: true, role: 'FACULTY' },
  { id: 'f3', name: 'Dr. Venkat Rao', email: 'dr.venkat.rao@nitw.ac.in', studentId: 'FAC-NITW-045', collegeId: 'FAC-NITW-045', collegeName: 'NIT Warangal', department: 'Mechanical Engineering', year: 1, phone: '+91 73456 78902', avatar: 'VR', rating: 4.8, totalRides: 37, isVerified: true, role: 'FACULTY' },
  { id: 'f4', name: 'Prof. Sunita Gupta', email: 'prof.sunita.gupta@cbit.ac.in', studentId: 'FAC-CBIT-088', collegeId: 'FAC-CBIT-088', collegeName: 'Chaitanya Bharathi Institute of Technology', department: 'Physics & Nanotech', year: 1, phone: '+91 64567 89013', avatar: 'SG', rating: 4.9, totalRides: 51, isVerified: true, role: 'FACULTY' },
  { id: 'f5', name: 'Dr. Anil Kumar', email: 'dr.anil.kumar@osmania.ac.in', studentId: 'FAC-OU-007', collegeId: 'FAC-OU-007', collegeName: 'Osmania University', department: 'Dean of Sciences', year: 1, phone: '+91 55678 90124', avatar: 'AK', rating: 4.7, totalRides: 29, isVerified: true, role: 'FACULTY' },
]
